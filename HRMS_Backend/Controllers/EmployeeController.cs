...
namespace HRMS_Backend.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public EmployeeController(IDashboardService dashboardService,IEmployeeResignationService resignationService,IShiftAllocationService shiftAllocationService,  IemployeeService employeeService, ILeaveService leaveService, IWebHostEnvironment env, IEmployeeKpiService kpiService, IManagerKpiReviewService managerReviewService, IEmailService emailService, HRMSContext context)
        {
...
public class UpdateResignationStatusRequest
{
    ...
    ";
        ...
        [HttpPost("UpdateResignationStatus")]
